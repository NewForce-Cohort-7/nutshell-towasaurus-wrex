...
// lets listen for the click of the image delete button and delete the image when clicked
...
// lets listen for the click of the add new image button and display the new image form when clicked
...
// lets listen for the click of the save image button
document.addEventListener("click", clickEvent => {
